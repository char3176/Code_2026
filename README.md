...
-Upgrade the firmware on all CTRE devices via a ["Batch Field Upgrade"][https://v6.docs.ctr-electronics.com/en/stable/docs/tuner/device-list.html#batch-field-upgrade]
